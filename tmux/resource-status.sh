...
printf '#[bg=colour237,fg=colour255,bold] #[fg=%s,bg=colour237,bold]CPU #[fg=colour255,bg=colour237,bold]| #[fg=%s,bg=colour237,bold]MEM #[bg=colour237,fg=colour255,bold]#[default]' \
